        ...
        <form action="{{ route('clienti.update', $cliente) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" name="ragione_sociale" class="form-control" value="{{ old('ragione_sociale', $cliente->ragione_sociale) }}" required>
                </div>
                <div class="col-sm-6">
                    <label class="form-label fw-medium">Partita IVA</label>
                    <input type="text" name="partita_iva" class="form-control" value="{{ old('partita_iva', $cliente->partita_iva) }}">
                </div>
                <div class="col-sm-6">
                    <label class="form-label fw-medium">Codice Fiscale</label>
                    <input type="text" name="codice_fiscale" class="form-control" value="{{ old('codice_fiscale', $cliente->codice_fiscale) }}">
                </div>
                <div class="col-12">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" name="provincia" class="form-control" maxlength="2" value="{{ old('provincia', $cliente->provincia) }}">
                </div>
                <div class="col-sm-3">
                    <label class="form-label fw-medium">CAP</label>
                    <input type="text" name="cap" class="form-control" value="{{ old('cap', $cliente->cap) }}">
                </div>
                <div class="col-sm-6">
                    <label class="form-label fw-medium">Referente</label>
                    <input type="text" name="referente" class="form-control" value="{{ old('referente', $cliente->referente) }}">
                </div>
                <div class="col-sm-6">
                    <label class="form-label fw-medium">Telefono</label>
                    <input type="tel" name="telefono" class="form-control" value="{{ old('telefono', $cliente->telefono) }}">
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="email" name="pec" class="form-control" value="{{ old('pec', $cliente->pec) }}">
                </div>
                <div class="col-sm-4">
                    <label class="form-label fw-medium">Codice SDI</label>
                    <input type="text" name="codice_sdi" class="form-control" maxlength="7" value="{{ old('codice_sdi', $cliente->codice_sdi) }}">
                </div>
                <div class="col-12">
                    <label class="form-label fw-medium">Note</label>
                    <textarea name="note" class="form-control" rows="3">{{ old('note', $cliente->note) }}</textarea>
                </div>
            </div>
